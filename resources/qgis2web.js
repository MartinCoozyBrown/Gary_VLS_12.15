      ...
      map.getView().fit([-9734059.034422, 5088300.323124, -9705406.817385, 5109001.671136], map.getSize());

      var NO_POPUP = 0
      var ALL_FIELDS = 1

      popupLayers = ["sitename","mdeededOwn","UNITNAME","ADDRESS","ADDRESS","ADDRESS","ADDRESS","FULL_ADDR","FULL_ADDR","FULL_ADDR","NAME",0,0];
